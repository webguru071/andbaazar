...
<head>
    ...
    <title>Andbaazar Product Reject Reason</title>
        ...
        <tr>
            <td>
                <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                    Eamil For Krishi product Reject
                </div>
            </td>
        </tr>
    </table>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                               ...
                               <span style="color: #5caad2;">Andbaazar</span>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px">
                                          ...
                                          Dear Seller ,
                                          <p>
                                            Your Krishi product has been rejected. <br> Rejected reason given below:<br>
                                            
                                             @foreach($rej_desc as $row)
                                             <ul>
                                                 <li>{{$row->rej_name}}</li>
                                             </ul> 
                                             @endforeach
