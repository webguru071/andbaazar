            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                        <form class="needs-validation" novalidate="" action="{{ action('Admin\CouponCodeController@store') }}" method="post">
                            @csrf
                            <h4>General</h4>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <input name="title" class="form-control col-md-7" id="validationCustom0" type="text" required value="{{ old('title') }}">
                                    </div>
                                    <div class="form-group row">
                                        <label for="validationCustom1" class="col-xl-3 col-md-4">Coupan Code <span>*</span></label>
                                        <input name="code" class="form-control col-md-7" id="validationCustom1" type="text" required value="{{ old('code') }}" >
                                        <div class="valid-feedback">Please Provide a Valid Coupon Code.</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4">Start Date <span>*</span> </label>
                                        <input name="valid_from" class="datepicker-here form-control digits col-md-7" type="text" data-language="en" required value="{{ old('valid_from') }}">
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4">End Date <span>*</span> </label>
                                        <input name="valid_to" class="datepicker-here form-control digits col-md-7" type="text" data-language="en" required value="{{ old('valid_to') }}">
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input name="discount_amount" class="form-control col-md-7" type="number" required value="{{ old('discount_amount') }}">
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4">Max Discount Amount</label>
                                        <input name="max_discount_amount" class="form-control col-md-7" type="number" value="{{ old('max_discount_amount') }}">
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4">Status</label>
                                        <div class="checkbox checkbox-primary col-md-7">
                                            <input name="status" id="checkbox-primary-2" type="checkbox" data-original-title="" title="" value="1">
                    ...
                    <div class="tab-pane fade" id="restriction" role="tabpanel" aria-labelledby="restriction-tabs">
                        <form class="needs-validation" novalidate="">
                            ...
                            <div class="form-group row">
                                ...
                                <input name="min_order_amount" class="form-control col-md-7" id="validationCustom4" type="number" value="{{ old('min_order_amount') }}">
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade" id="usage" role="tabpanel" aria-labelledby="usage-tab">
                        <form class="needs-validation" novalidate="">
                            ...
                            <div class="form-group row">
                                ...
                                <input name="max_using_limit" class="form-control col-md-7" type="number" value="{{ old('max_using_limit') }}">
                            </div>
                            <div class="form-group row">
                                <label for="validationCustom7" class="col-xl-3 col-md-4">Per Customer</label>
                                <input name="single_user_max_using_limit" class="form-control col-md-7" id="validationCustom7" type="number" value="{{ old('single_user_max_using_limit') }}">
                            </div>
                        </form>
                    </div>
                </div>
