...
{{--                    <li><a class="sidebar-header {{ request()->is('andbaazaradmin/customers') ? 'active' : '' }}"  href="{{ action('Admin\CustomerController@index') }}"><i data-feather="users"></i><span>Customers</span></a> </li>--}}
                    ...
                    <li class="{{ request()->is('andbaazaradmin/krishi/products*') ? 'active' : '' }}"><a class="sidebar-header {{ request()->is('andbaazaradmin/krishi/products*') ? 'active' : '' }}" href="#"><i data-feather="package"></i> <span>Krishi Products</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li class="{{ request()->is('andbaazaradmin/krishi/products/active*') ? 'active' : '' }}"><a href="#" class="{{ request()->is('andbaazaradmin/krishi/products/active*') ? 'active' : '' }}"><i class="fa fa-circle"></i> <span>Active Products</span></a></li>
                            <li class="{{ request()->is('andbaazaradmin/krishi/products/pending*') ? 'active' : '' }}"><a href="#" class="{{ request()->is('andbaazaradmin/krishi/products/pending*') ? 'active' : '' }}"><i class="fa fa-circle"></i> <span>Pending Products</span></a></li>
                            <li class="{{ request()->is('andbaazaradmin/krishi/products/rejected*') ? 'active' : '' }}"><a href="#" class="{{ request()->is('andbaazaradmin/krishi/products/rejected*') ? 'active' : '' }}"><i class="fa fa-circle"></i> <span>Rejected Products</span></a></li>
