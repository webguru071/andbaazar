                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table class="table table-borderd" id="showInDataTable">
                            ...
                            @foreach($rejected_customers as $index=>$customer)
                                <tr>
                                    <td><img class="img-fluid" src="{{ (!is_null($customer->customerDetails['picture'])) ? $merchant->customerDetails['picture'] : asset('images/avatar-user.png') }}" style="height: 50px"></td>
