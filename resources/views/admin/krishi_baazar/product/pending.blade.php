                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table class="table table-borderd" id="showInDataTable">
                            ...
                            <tbody>
                            @foreach($pending_krishi_products as $index=>$krishi_product)
                                <tr>
                                    ...
                                    <td>{{ $krishi_product->available_to }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-secondary btn-xs" href="{{ action('Admin\KrishiProductController@approveProduct',$krishi_product->id) }}">Approve</a>
                                        <a class="btn btn-danger btn-xs" href="{{ action('Admin\KrishiProductController@rejectProduct',$krishi_product->id) }}">Reject</a>
