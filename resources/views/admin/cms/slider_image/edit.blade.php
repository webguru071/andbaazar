            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation add-product-form" action="{{ action('Admin\KrishiBazarSliderController@update',$krishiBazarSlider->id) }}" novalidate="" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                                ...
                                <div class="col-xl-7 col-md-7">
                                    <div class="form">
                                        <div class="form-group mb-3 row">
                                            ...
                                            <input name="slider_url" class="form-control col-xl-8 col-sm-7" id="sliderURL" type="url" required value="{{ $krishiBazarSlider->slider_url }}">
                                        </div>
                                    </div>
                                    <div class="form">
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-sm-4 mb-0">Description :</label>
                                            <textarea class="form-control col-xl-8 col-sm-7" name="slider_details" rows="4">{{ $krishiBazarSlider->slider_details }}</textarea>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control digits col-xl-8 col-sm-7" id="sliderStatus" name="status" required>
                                                <option value="1" {{ ($krishiBazarSlider->status==1) ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ ($krishiBazarSlider->status==0) ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
