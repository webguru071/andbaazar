...
@component('admin.layout.inc.breadcrumb')
  ...
  @slot('page')
      ...
      <li class="breadcrumb-item active" aria-current="page"> Auction Product </li>
  @endslot
@endcomponent
<div class="container-fluid">
    <div class="row products-admin ratio_asos">
        @foreach($auctionproduct as $row)
                        ...
                        <div class="img-wrapper">
                            <div class="">
                                @foreach($row->itemimage as $itemimg)
                                    @if($loop->first) 
                                        <a href="{{ url('/merchant/auction/products/'.$row->id) }}"><img src="{{ !empty($row->image) ? asset($row->image) : asset('/uploads/auction/auction.png') }}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                    @endif
                                @endforeach 
                            </div>
                        </div>
