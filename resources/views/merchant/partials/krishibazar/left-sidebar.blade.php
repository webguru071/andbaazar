<ul class="nav nav-tabs" id="top-tab" role="tablist">
    ...
    <li class="nav-item"><a class="nav-link {{ Request::is('merchant/krishi/products') ? 'active' : ''}}" href="{{ url('merchant/krishi/products') }}">Products</a> </li>

    <li class="nav-item"><a class="nav-link {{ Request::is('merchant/krishi/inventories') ? 'active' : ''}}" href="{{ url('merchant/krishi/inventories') }}">Inventories</a> </li>
