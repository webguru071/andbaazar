<ul class="nav nav-tabs" id="top-tab" role="tablist">
    ...
    <li class="nav-item"><a class="nav-link {{ Request::is('merchant/sme/products') ? 'active' : ''}}" href="{{ url('merchant/sme/products') }}">Products</a> </li>

    <li class="nav-item"><a class="nav-link {{ Request::is('merchant/sme/inventories') ? 'active' : ''}}" href="{{ url('merchant/sme/inventories') }}">Inventories</a> </li>
